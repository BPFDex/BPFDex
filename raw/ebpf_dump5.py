...
file_sym = "_ZN3art11interpreter34ArtInterpreterToCompiledCodeBridgeEPNS_6ThreadEPNS_9ArtMethodEPKNS_7DexFile8CodeItemEPNS_11ShadowFrameEPNS_6JValueE"
bpf_c_code = open("ebpf_dump5.c").read()
...
def output(cpu, data, size):
    ...
    try:
        ...
        print("registers_size_:{0}     ins_size_:{1}      insns_size_in_code_units_:{2}".format(item.registers_size_,item.ins_size_,item.insns_size_in_code_units_))
