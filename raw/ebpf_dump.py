...
file_sym = "_ZN3art7DexFile10OpenMemoryEPKhjRKNSt3__112basic_stringIcNS3_11char_traitsIcEENS3_9allocatorIcEEEEjPNS_6MemMapEPKNS_10OatDexFileEPS9_"
dex_index=0
bpf_c_code = open("ebpf_dump.c").read()
...
def output(cpu, data, size):
    ...
    if(event.comm.decode('utf-8')=="om.mt.mtxx.mtxx"):
