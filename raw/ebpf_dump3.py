...
file_sym = "_ZN3art7DexFileC1EPKhjRKNSt3__112basic_stringIcNS3_11char_traitsIcEENS3_9allocatorIcEEEEjPNS_6MemMapEPKNS_10OatDexFileE"
bpf_c_code = open("ebpf_dump3.c").read()
...
def output(cpu, data, size):
    ...
    if(event.comm.decode('utf-8')=="d.apps.poseidon"):
