...
int trace_DexFile(struct pt_regs *ctx) {
  ...
  current_data.arg1 =ctx->r11;
  u64 addr=current_data.arg1+0x20;
  bpf_probe_read_user(&current_data.arg2,sizeof(current_data.arg2),(unsigned int*)addr);
  bpf_probe_read_user_str(&current_data.magic, sizeof(current_data.magic),
                        (unsigned char*)(current_data.arg1));
